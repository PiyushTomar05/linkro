...
export default function ManageUsers() {
  const [users, setUsers] = useState([
    { id: 1, name: "Rahul Sharma", email: "rahul@example.com", role: "agent", status: "active" },
    { id: 2, name: "Neha Verma", email: "neha@example.com", role: "recruiter", status: "active" },
    { id: 3, name: "Admin User", email: "admin@example.com", role: "admin", status: "disabled" },
  ]);
