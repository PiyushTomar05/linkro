  ...
  const getNavItems = () => {
    ...
    if (role === "admin") {
      ...
      return [
        ...
        { name: "My Applications", path: "/agent/applications", icon: UsersIcon },
      ];
    }
    return [];
  };
      ...
      >
        <div className="h-full flex flex-col">
          ...
          <div className="p-4 border-t border-slate-100">
            <Link to="/profile" className="flex items-center gap-3 px-4 py-3 mb-2 rounded-xl bg-slate-50 hover:bg-indigo-50 transition-colors group">
              <div className="w-8 h-8 rounded-full bg-indigo-100 flex items-center justify-center text-indigo-600 font-bold text-xs group-hover:bg-white">
